...
drush -y -u 1 en php_lib islandora objective_forms
drush -y -u 1 en islandora_solr_metadata islandora_solr_facet_pages islandora_solr_views islandora_solr_search
drush -y -u 1 en islandora_solution_pack_collection islandora_solution_pack_pdf islandora_solution_pack_audio islandora_solution_pack_book islandora_solution_pack_compound islandora_solution_pack_entities islandora_solution_pack_image islandora_solution_pack_large_image islandora_solution_pack_newspaper islandora_solution_pack_video islandora_solution_pack_web_archive islandora_solution_pack_document
drush -y -u 1 en islandora_premis islandora_checksum islandora_checksum_checker
drush -y -u 1 en islandora_book_batch islandora_pathauto islandora_pdfjs islandora_videojs
drush -y -u 1 en islandora_xml_forms islandora_solution_pack_image islandora_solution_pack_compound islandora_scholar
...
drush -y -u 1 en umkcdora umkc-feature-types umkc_islandora_browse
